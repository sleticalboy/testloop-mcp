...
type generateTestsInput struct {
	...
	Framework    string                  `json:"framework,omitempty" jsonschema:"测试框架，可选值: go-test/cargo-test/jest/vitest/mocha/node-test/pytest/junit，默认自动检测，JS/TS 会读取 package.json"`
