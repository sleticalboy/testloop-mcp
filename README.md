...
当前 `v0.5.20` Release 已提供 Linux amd64、Linux arm64、macOS arm64、Windows amd64 和 Windows arm64 二进制。手动下载示例：

```bash
curl -LO https://github.com/sleticalboy/testloop-mcp/releases/download/v0.5.20/testloop-mcp_v0.5.20_linux_amd64.tar.gz
curl -LO https://github.com/sleticalboy/testloop-mcp/releases/download/v0.5.20/testloop-mcp_v0.5.20_linux_amd64.tar.gz.sha256
sha256sum -c testloop-mcp_v0.5.20_linux_amd64.tar.gz.sha256
tar -xzf testloop-mcp_v0.5.20_linux_amd64.tar.gz
./testloop-mcp --help
```
...
```powershell
$arch = "amd64"
curl.exe -LO "https://github.com/sleticalboy/testloop-mcp/releases/download/v0.5.20/testloop-mcp_v0.5.20_windows_$arch.zip"
curl.exe -LO "https://github.com/sleticalboy/testloop-mcp/releases/download/v0.5.20/testloop-mcp_v0.5.20_windows_$arch.zip.sha256"
$expected = (Get-Content ".\testloop-mcp_v0.5.20_windows_$arch.zip.sha256").Split()[0]
$actual = (Get-FileHash ".\testloop-mcp_v0.5.20_windows_$arch.zip" -Algorithm SHA256).Hash.ToLower()
if ($actual -ne $expected) { throw "checksum mismatch" }
Expand-Archive ".\testloop-mcp_v0.5.20_windows_$arch.zip"
& ".\testloop-mcp_v0.5.20_windows_$arch\testloop-mcp.exe" --help
& ".\testloop-mcp_v0.5.20_windows_$arch\testloop-testgen.exe" --help
```
...
```bash
TESTLOOP_MCP_VERIFY_EXPECT_VERSION=0.5.20 scripts/verify-client-setup.sh /absolute/path/to/testloop-mcp
```
...
```bash
TESTLOOP_REPORT_EXPECT_VERSION=0.5.20 \
...
也可以不 clone 仓库，直接下载 v0.5.20 的单脚本安装模板：
