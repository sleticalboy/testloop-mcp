...
assert_contains "$out" "agent_decision_client_ci_template_ref=v0.5.20"
...
assert_contains "$custom_workflow" "ref: v0.5.20"
...
assert_contains "$out" "agent_decision_client_ci_template_ref=v0.5.20"
assert_contains "${standalone_client_dir}/.github/workflows/testloop-agent-decision-contract.yml" "ref: v0.5.20"
