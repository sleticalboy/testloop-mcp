...
required_snippets = [
    ...
    "node scripts/validate-agent-decision-client-ci-summary.mjs /path/to/testloop-agent-decision-client-summary.json",
    "node scripts/render-agent-decision-client-ci-response.mjs /path/to/testloop-agent-decision-client-summary.json",
    "./fixtures/agent-decision-client-ci-response.schema.json",
    "./fixtures/agent-decision-client-ci-response/passed.json",
    "./fixtures/agent-decision-client-ci-response/validator-failed.json",
    "./fixtures/agent-decision-client-ci-response/fixture-drift.json",
    "node scripts/validate-agent-decision-client-ci-response.mjs /path/to/client-ci-response.json",
    ...
    "./fixtures/agent-decision-client-adopter-summary.schema.json",
    "./fixtures/agent-decision-client-adopter-summary/passed.json",
    "./fixtures/agent-decision-client-adopter-summary/invalid-response.json",
    ...
    "./fixtures/agent-decision-client-consumer-response.schema.json",
    "./fixtures/agent-decision-client-consumer-response/passed.json",
    "./fixtures/agent-decision-client-consumer-response/client-summary-validator-failed.json",
    ...
    "./fixtures/release-response-adopter-artifact-verification.schema.json",
    "./fixtures/release-response-adopter-artifact-verification/passed.json",
    ...
    "client_decision=inspect-artifact",
    ...
    "testloop_release_response_summary_*",
...
command_paths = {
    ...
    "go run ./examples/release-response-adopter-artifact-demo": Path("examples/release-response-adopter-artifact-demo/main.go"),
    ...
    "node scripts/validate-agent-decision-client-ci-summary.mjs": Path("scripts/validate-agent-decision-client-ci-summary.mjs"),
    "node scripts/render-agent-decision-client-ci-response.mjs": Path("scripts/render-agent-decision-client-ci-response.mjs"),
    "node scripts/validate-agent-decision-client-ci-response.mjs": Path("scripts/validate-agent-decision-client-ci-response.mjs"),
    "scripts/showcase-agent-decision-client-adopter.sh": Path("scripts/showcase-agent-decision-client-adopter.sh"),
    "node scripts/validate-agent-decision-client-adopter-summary.mjs": Path("scripts/validate-agent-decision-client-adopter-summary.mjs"),
    ...
    "node scripts/validate-agent-decision-client-consumer-response.mjs": Path("scripts/validate-agent-decision-client-consumer-response.mjs"),
    ...
    "node scripts/validate-release-response-adopter-artifact-verification.mjs": Path("scripts/validate-release-response-adopter-artifact-verification.mjs"),
