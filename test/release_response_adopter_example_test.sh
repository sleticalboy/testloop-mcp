...
assert_contains "$readme" "node scripts/verify-release-response-adopter-artifact.mjs"
assert_contains "$readme" "node scripts/validate-release-response-adopter-artifact-verification.mjs"
...
assert_contains "$readme" "testloop-release-response-adopter-artifacts"
assert_contains "$readme" "testloop-release-response-adopter-summary.json"
assert_contains "$readme" "testloop-release-response-install-summary.json"
assert_contains "$readme" "testloop-release-response-client/testloop-release-response.json"
...
assert_contains "$readme" "release-response-adopter-artifact-verification.schema.json"
assert_contains "$readme" "missing-summary-consumer.json"
