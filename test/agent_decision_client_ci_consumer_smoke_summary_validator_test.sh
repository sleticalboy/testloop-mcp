...
payload["client_response_validator_exit_code"] = 1
payload["fixture_validator_exit_code"] = 1
payload["failures"] = ["boom"]
payload["client_summary_validator_json"] = ""
payload["client_response_json"] = ""
payload["client_response_validator_json"] = ""
...
assert_contains "${tmp_dir}/bad.out" "client_response_validator_exit_code must be 0"
...
assert_contains "${tmp_dir}/bad.out" "client_response_json"
assert_contains "${tmp_dir}/bad.out" "client_response_validator_json"
