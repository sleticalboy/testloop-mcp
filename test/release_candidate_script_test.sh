...
assert_contains "$script" 'node scripts/verify-release-response-adopter-artifact.mjs --json "$release_response_adopter_artifact_dir" > "$release_response_adopter_artifact_verification"'
assert_contains "$script" 'node scripts/validate-release-response-adopter-artifact-verification.mjs "$release_response_adopter_artifact_verification"'
