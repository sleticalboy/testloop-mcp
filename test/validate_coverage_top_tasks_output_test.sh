...
out="${tmp_dir}/java-help.out"
run_expect_code 0 "$out" bash "${repo_root}/scripts/validate-java-coverage-top-tasks.sh" --help
assert_contains "$out" "TESTLOOP_VALIDATE_JAVA_COVERAGE_FILE"
