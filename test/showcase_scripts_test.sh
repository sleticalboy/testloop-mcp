...
test_showcase_scripts_are_valid_bash() {
  ...
  node --check "${repo_root}/scripts/validate-agent-decision-client-ci-response.mjs"
  ...
  node --check "${repo_root}/scripts/validate-agent-decision-client-adopter-summary.mjs"
