...
for path in [
    ...
    Path("scripts/validate-release-response-adopter-summary.mjs"),
    Path("scripts/verify-release-response-adopter-artifact.mjs"),
    Path("scripts/validate-release-response-adopter-artifact-verification.mjs"),
    Path("docs/fixtures/release-response-adopter-artifact-verification.schema.json"),
    Path("docs/fixtures/release-response-adopter-artifact-verification/passed.json"),
    Path("docs/fixtures/release-response-adopter-artifact-verification/missing-summary-consumer.json"),
    Path("docs/fixtures/release-response-adopter-summary.schema.json"),
    Path("docs/fixtures/release-response-adopter-summary/passed.json"),
