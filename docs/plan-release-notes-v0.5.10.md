...
- [x] 正式版本准备本地完整验证已通过。
- [x] 正式版本准备提交 `df4a2c3` 远端 CI run `29673498767` passed。
- [x] `v0.5.10` tag 已推送，Release Artifacts run `29673555807` passed。
- [x] 10 个 GitHub Release 资产已通过 `scripts/verify-release-assets.sh v0.5.10` 验证。
- [x] GitHub Release 正文已更新为正式 v0.5.10 发布说明。
- [x] 仓库内 `Formula/testloop-mcp.rb` 已生成 v0.5.10 版本和真实 sha256。
- [x] 仓库内 Formula 和发布记录提交 `530007e` 远端 CI run `29673720034` passed。
- [x] Homebrew tap 已更新到 v0.5.10，tap commit `54e7c91`。
- [x] Post-Release Verify run `29673822611` passed。
...
- [x] 正式版本准备提交 `df4a2c3` 远端 CI run `29673498767` passed。
- [x] Release Artifacts run `29673555807` passed。
- [x] `scripts/verify-release-assets.sh v0.5.10`
- [x] 仓库内 Formula 和发布记录提交 `530007e` 远端 CI run `29673720034` passed。
- [x] Homebrew tap commit `54e7c91`。
- [x] Post-Release Verify run `29673822611` passed。

## 发布备注

- v0.5.10 已作为“CI artifact 直接携带 Agent 回复草稿”的 patch 版本发布。
- 发布文案突出：first-run 和 onboarding 两条 bootstrap 的失败消费路径已统一。
