...
- [ ] 正式版本准备时更新 `main.go` MCP implementation version 到 `0.5.3`。
- [ ] 正式版本准备时将 `CHANGELOG.md` 的 `Unreleased` 内容收敛为 `v0.5.3 - 2026-07-18`。
...
- [x] `TESTLOOP_REPORT_EXPECT_VERSION=0.5.2 TESTLOOP_REPORT_SUMMARY_JSON=/tmp/testloop-v0.5.3-summary.json scripts/generate-verification-report.sh /tmp/testloop-mcp-v0.5.3-prep /tmp/testloop-v0.5.3-report.md`
