...
- [x] 候选提交远端 CI 已通过到 `1a9480e`，最新成功 run 为 `29670477128`。
...
- [x] 正式版本准备已更新 `main.go` MCP implementation version 到 `0.5.9`。
- [x] 正式版本准备已将 `CHANGELOG.md` 的 `Unreleased` 内容收敛为 `v0.5.9 - 2026-07-19`。
- [x] 正式版本准备已同步 README、安装文档和必要版本引用到 `v0.5.9`。
- [x] 正式版本准备本地完整验证已通过。
- [x] 正式版本准备提交 `c8a56cb` 远端 CI run `29670649066` passed。
- [x] `v0.5.9` tag 已推送，Release Artifacts run `29670770869` passed。
- [x] 10 个 GitHub Release 资产已通过 `scripts/verify-release-assets.sh v0.5.9` 验证。
- [x] GitHub Release 正文已更新为正式 v0.5.9 发布说明。
- [x] 仓库内 `Formula/testloop-mcp.rb` 已生成 v0.5.9 版本和真实 sha256。
- [x] 仓库内 Formula 和发布记录提交 `a3f73b6` 远端 CI run `29670948462` passed。
- [x] Homebrew tap 已更新到 v0.5.9，tap commit `62280bf`。
- [x] Post-Release Verify run `29671001523` passed。
...
- [x] 正式版本准备复跑：脚本语法、`go test ./...`、完整 shell 矩阵、主服务/testgen 构建、`testloop-mcp 0.5.9` 版本输出、help 输出、darwin arm64 打包 dry-run、sha256 校验、tarball 内容检查和 `git diff --check`。
- [x] 正式版本准备提交 `c8a56cb` 远端 CI run `29670649066` passed。
- [x] Release Artifacts run `29670770869` passed。
- [x] `scripts/verify-release-assets.sh v0.5.9`
- [x] 仓库内 Formula 和发布记录提交 `a3f73b6` 远端 CI run `29670948462` passed。
- [x] Homebrew tap commit `62280bf`。
- [x] Post-Release Verify run `29671001523` passed。

## 发布备注

- v0.5.9 已作为“first-run artifact 可被 Agent/客户端稳定消费”的 patch 版本发布。
