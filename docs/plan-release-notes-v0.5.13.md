...
- [ ] 正式版本准备时更新 `main.go` MCP implementation version 到 `0.5.13`。
- [ ] 将 `CHANGELOG.md` 的 `Unreleased` 内容收敛为 `v0.5.13 - 2026-07-20`。
- [ ] 同步 README、安装文档和必要版本引用到 `v0.5.13`。
- [ ] 跑完整 release readiness。
- [ ] 打 tag、生成 Release 资产、更新 GitHub Release 和 Homebrew tap。
