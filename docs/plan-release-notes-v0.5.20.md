...
- [x] 版本准备提交 `353d255` 的远端 CI run `29846178265` passed。
- [x] `v0.5.20` tag 已推送，指向 `44c2344`。
- [x] Release Artifacts workflow run `29847487312` passed，正式 GitHub Release 已包含 10 个 assets。
- [x] GitHub Release 正文已更新为正式 v0.5.20 发布说明。
- [x] Homebrew tap 已更新到 `0.5.20`，tap commit `bee0521`。
- [x] 发布后 release smoke 与 release response smoke 已通过。
- [x] Post-Release Verify run `29848148743` passed，覆盖 asset manifest 和五个平台安装校验。
- [x] 发布记录提交 `c22cd07` 的远端 CI run `29849305668` passed。
...
- v0.5.20 发布闭环已完成；下一步回到产品主线，继续做真实外部客户端/Agent 接入样板。
