...
- [ ] Post-Release Verify run `29828306451` 已触发，当前等待 GitHub runner。
...
- v0.5.19 已完成 tag、Release assets、资产校验、GitHub Release 正文、仓库内 Formula、Homebrew tap 和发布后 smoke；Post-Release Verify 已触发，等待 GitHub runner 执行。
