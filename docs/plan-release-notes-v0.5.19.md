...
- [x] 最新已完成的远端 CI：`b78a375` run `29826190450` passed，覆盖基础客户端 CI response artifact。
- [ ] 正式版本准备尚未开始：`main.go` implementation version 仍是当前发布版本，`CHANGELOG.md` 仍保留 Unreleased。
...
- 正式发布前仍需完成版本号切换、CHANGELOG 收敛、release readiness、tag、Release assets、GitHub Release 正文和 Homebrew tap 更新。
