...
已完成补充：release response contract 现在有可复制的外部客户端样板、接入方 JSON 消费 helper、临时外部仓库 showcase、真实案例记录和文档回归测试。下一步应跑新增样板测试、真实案例文档测试、文档链接、Go 测试和 diff check；通过后提交并等待 main CI。
