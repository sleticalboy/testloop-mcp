...
已完成补充：v0.5.17 已完成正式 GitHub Release、五平台资产发布、资产清单校验、仓库内 Formula、Homebrew tap 和 Post-Release Verify。下一步应提交发布完成记录并等待 main CI；CI 通过后回到主线产品价值，继续围绕真实客户端/Agent 消费路径补证据。
