...
10. [ ] Post-Release Verify run `29828306451` 已触发，当前等待 GitHub runner。

已完成补充：v0.5.19 已完成正式 GitHub Release、五平台资产发布、资产清单校验、GitHub Release 正文、仓库内 Formula、Homebrew tap 和发布后 smoke。下一步等待 Post-Release Verify 通过；通过后提交发布完成记录并等待 main CI。
