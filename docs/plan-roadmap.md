...
10. [ ] Post-Release Verify run `29848148743` 已触发，当前等待 GitHub runner 分配。

已完成补充：v0.5.20 已完成正式 GitHub Release、五平台资产发布、资产清单校验、GitHub Release 正文、仓库内 Formula、Homebrew tap 和发布后 smoke。下一步应等待 Post-Release Verify 完成；通过后提交发布完成记录并等待 main CI。
