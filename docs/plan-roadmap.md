...
8. [ ] 提交仓库内 Formula 和发布记录，并等待 main CI passed。
9. [ ] 更新并推送 Homebrew tap 到 `0.5.11`。
10. [ ] 手动触发 Post-Release Verify，确认资产清单和五平台安装脚本 dry run 全部通过。

已完成补充：v0.5.11 已完成 GitHub Release 主链路和仓库内 Formula 生成，当前发布收尾只剩 Formula/文档提交、Homebrew tap 更新和 Post-Release Verify。
