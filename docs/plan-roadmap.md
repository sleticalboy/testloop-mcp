...
8. [ ] 提交版本准备改动并等待 main CI passed。

已完成补充：v0.5.20 正式版本准备已完成本地门禁，当前仍不打 tag、不创建 GitHub Release、不更新 Homebrew tap。下一步应提交并 push，观察 main CI；CI 通过后再进入正式 tag 与 Release assets 阶段。
