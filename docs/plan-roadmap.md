...
14. [ ] 仓库内 Formula 和发布记录提交后等待远端 CI 通过。
15. [ ] Homebrew tap 和 Post-Release Verify 仍待完成。

已完成补充：v0.5.10 已完成 tag、Release Artifacts、资产校验、GitHub Release 正文和仓库内 Formula 生成。下一步建议提交仓库内 Formula 和发布记录，等待远端 CI 后更新 Homebrew tap。
