...
9. [ ] 正式版本准备提交后等待远端 CI 通过。
10. [ ] `v0.5.10` tag、Release Artifacts、资产校验、GitHub Release 正文、仓库内 Formula、Homebrew tap 和 Post-Release Verify 仍待完成。

已完成补充：v0.5.10 正式版本准备已经完成本地门禁，但还没提交和发布。下一步建议提交版本准备改动，等待远端 CI 通过后执行 tag 与发布流程。
