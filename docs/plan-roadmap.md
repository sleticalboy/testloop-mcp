...
已完成补充：外部客户端现在有一份按步骤执行的 release response checklist，不需要从长文档里自行拼接命令。下一步应跑 checklist 文档测试、release response 客户端文档测试、release doc index、文档链接、Go 测试和 diff check；通过后提交并等待 main CI。
