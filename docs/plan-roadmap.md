...
4. [x] `test/showcase_scripts_test.sh` 已覆盖 shared helper 的直跑路径、语法回归以及 laoxia wrapper 的成功/失败路径。
5. [x] 真实 laoxia 样本复验通过：`/tmp/testloop-laoxia-scaffold-live2/laoxia-summary.json` 显示 server/web 两边都为 `passed`。
