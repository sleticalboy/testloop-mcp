...
5. [x] `docs/verification-report.md`、`docs/verification-ci.md`、`docs/first-run-ci-template.md` 和 `docs/onboarding-ci-template.md` 已同步说明 summary artifact 会自带 schema。
