...
已完成补充：发版前门禁现在会同时覆盖 release response 导出包和真实仓库安装 summary。下一步应跑 release candidate 脚本测试、新 installer/validator 测试、相关文档测试、Go 测试和 diff check；通过后提交并等待 main CI。
