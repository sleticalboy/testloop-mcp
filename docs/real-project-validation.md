...
| 15 | JSON-java | Java / Maven + JUnit + JaCoCo | `JSONArray.java` top10 | 初跑 `passed=4/failed=6`；修复后 `passed=10`，`ready=6`，`manual_review_internal=4`，`zero_skip=0` | 0 |
