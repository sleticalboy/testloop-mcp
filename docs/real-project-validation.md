...
| 16 | Apache Commons Codec | Java / Maven + JUnit + JaCoCo | `Base64.java` top5 | 初跑 `passed=3/failed=2`；修复后 `passed=5/ready=2/manual_review_internal=3`，生成测试写入 `Base64TestLoopTest.java`，不覆盖既有 `Base64Test.java` | 0 |
