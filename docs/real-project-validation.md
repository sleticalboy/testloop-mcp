...
| 16 | Apache Commons Codec | Java / Maven + JUnit + JaCoCo | `Base64.java` top5 + `DigestUtils.java` top10 + `Rule.java` top10 | `Base64: 初跑 passed=3/failed=2；修复后 passed=5/ready=2/manual_review_internal=3`；`DigestUtils: 初跑 failed=10；修复后 passed=10/ready=10`；`Rule: 初跑 passed=6/failed=4；修复后 passed=10/ready=4/manual_review_internal=6` | 0 |
