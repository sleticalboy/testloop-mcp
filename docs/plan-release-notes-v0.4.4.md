...
- [ ] 远端 CI passed
- [ ] Tag `v0.4.4` 已推送
- [ ] Release Artifacts run 已通过
- [ ] `v0.4.4` Release 已包含 Linux amd64、Linux arm64、macOS arm64 和 Windows amd64 四类资产及各自 `.sha256`
...
- [ ] `brew test sleticalboy/tap/testloop-mcp` 已验证 `0.4.4`
