...
- [x] Tag `v0.4.8` 已推送
- [x] `TESTLOOP_MCP_VERSION=v0.4.8 sh scripts/install.sh` 在 release 资产生成前可回退到 `go install`，并安装可用的 `testloop-mcp` / `testloop-testgen`
- [x] `TESTLOOP_MCP_VERSION=v0.4.8 TESTLOOP_MCP_INSTALL_DIR=... sh scripts/install.sh` 通过 release 资产下载、sha256 校验和解包安装
- [x] 远端 CI passed
- [x] Release Artifacts run 通过
- [x] `v0.4.8` Release 资产验证
- [x] Homebrew tap 更新到 `0.4.8`
- [x] `brew test sleticalboy/tap/testloop-mcp`

## 发布信息

- Tag: `v0.4.8` -> `61e500770f4a2a92254e2b52347a8b55f6030d82`
- Release: `testloop-mcp v0.4.8` 已发布，包含 darwin arm64、linux amd64、linux arm64、windows amd64、windows arm64 资产及对应 `.sha256`
- Release Artifacts run: `28793678783` success
- Homebrew tap commit: `ad9ec75f222f120964176df002277b6f1b942fa3`

## 发布后维护注意

- CI 如果因 GitHub runner 资源排队，应继续完成本地验证和发布资料准备；只有失败结论才需要阻塞发布。
- README 和安装文档里的 release 下载链接已在 Release Artifacts 上传完成并验证后切到 `v0.4.8`。
