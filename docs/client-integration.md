...
外部 CI 建议上传 `testloop-release-response-adopter-artifacts`，至少包含 `testloop-release-response-adopter-summary.json`、`testloop-release-response-install-summary.json`、`testloop-release-response-client/testloop-release-response.json`、`testloop-release-response-consumer.json` 和 `testloop-release-response-summary-consumer.json`。
