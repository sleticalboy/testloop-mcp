...
- [x] 远端 CI passed
- [x] Release Artifacts workflow passed
- [x] `v0.4.1` Release 已包含 `testloop-mcp_v0.4.1_linux_amd64.tar.gz` 和 `checksums.txt`
- [x] 远端 `go install github.com/sleticalboy/testloop-mcp@latest` 和 `go install github.com/sleticalboy/testloop-mcp/cmd/testgen@latest` 验证通过
